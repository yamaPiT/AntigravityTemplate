...
2. **[Knowledge]**: `docs/templates/SW105_ソフトウェア要求仕様書.md` をロードする。
...
3. **[Knowledge]**: `docs/templates/SW205_ソフトウェアアーキテクチャ設計書.md` をロードする。
...
2. **[Knowledge]**: `docs/templates/SWP6_ソフトウェア総合テスト仕様書・報告書.md` をロードする。
